...
public class BroadcastPreferences : RustPlugin
{
    ...
    public class Topic
    {
        ...
        internal void OnDeserializedMethod(StreamingContext context)
        {
            ...
            if (MessageRegexStrings != null && MessageRegexStrings.Count > 0)
            {
                ...
                {
                    LogError($"Invalid regex pattern in topic '{DisplayName}': '{MessageRegexStrings}'");
                    MessageRegexes = null;
                }
            }
            else
    ...
    {
        // { [topic: string]: { [userId: ulong]: Subscription } }
